module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        const url = 'https://api.otakugifs.xyz/gif/shoot';
        ...
        fetch(url, {
            ...
            if(message.mentions.members.size >= 1) {
                if(person.id == message.author.id) {
                    ...
                    .setAuthor(`${message.author.username} is shooting ${person.username}, so brutal`, message.author.displayAvatarURL({ dynamic: true }))
                    .setImage(json.url)
