                ...
                if(reaction.emoji.name === '👍') {
                    ...
                    .then(collected2 => {
                        ...
                        if(reaction2.emoji.name === '👍') {
                            ...
                            reaction2.users.remove(message.author.id);
                                ...
                                if(reaction3.emoji.name === '👍') {
                                    ...
                                    .then(collected4 => {
                                        ...
                                        if(reaction4.emoji.name === '👍') {
                                            ...
                                            reaction4.users.remove(message.author.id);    
                                        ...
                                        if(reaction4.emoji.name === '👎') {
                                            ...
                                            .then(collected5 => {
                                                ...
                                                if(reaction5.emoji.name === '👍') {
                                                    ...
                                                    reaction5.users.remove(message.author.id);
                                                    ...
                                                    .then(collected6 => {
                                                        ...
                                                        if(reaction6.emoji.name === '👍') {
                                                            ...
                                                            reaction6.users.remove(message.author.id);
                ...
                if(reaction.emoji.name === '✊') {
                    ...
                    .then(collected7 => {
                        ...
                        if(reaction7.emoji.name === '👍') {
                            ...
                            reaction7.users.remove(message.author.id);
                        ...
                        if(reaction7.emoji.name === '✊') {
                            ...
                            .then(collected8 => {
                                ...
                                if(reaction8.emoji.name === '👍') {
                                    ...
                                    reaction8.users.remove(message.author.id);
                ...
                if(reaction.emoji.name === '👎') {
                    ...
                    .then(collected9 => {
                        ...
                        if(reaction9.emoji.name === '👍') {
                            ...
                            reaction9.users.remove(message.author.id);
                            ...
                            .then(collected10 => {
                                ...
                                if(reaction10.emoji.name === '👍') {
                                    ...
                                    reaction10.users.remove(message.author.id);
                                    ...
                                    .then(collected11 => {
                                        ...
                                        if(reaction11.emoji.name === '👍') {
                                            ...
                                            reaction11.users.remove(message.author.id);
                                        ...
                                        if(reaction11.emoji.name === '👎') {
                                            ...
                                            .then(collected12 => {
                                                ...
                                                if(reaction12.emoji.name === '👍') {
                                                    ...
                                                    reaction12.users.remove(message.author.id);
                                ...
                                if(reaction10.emoji.name === '👎') {
                                    ...
                                    .then(collected13 => {
                                        ...
                                        if(reaction13.emoji.name === '👍' || reaction13.emoji.name === '👎') {
                                            message.channel.stopTyping();
                                            const choice = [
                                                `*You were wrong. You try to run away but then Edward gets his sword out and slices your head off*\n\n**YOU DIED**\nEnding 15 out of ${endings}: The lost bet\n${artist}`,
                                            ...
                                            reaction13.users.remove(message.author.id);
                                ...
                                if(reaction14.emoji.name === '👍') {
                                    ...
                                    .then(collected15 => {
                                        ...
                                        if(reaction15.emoji.name === '❤️') {
                                            ...
                                            if(!bot.user.hasPermission("MANAGE_NICKNAMES")) return;
