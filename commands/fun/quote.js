    ...
    run: async (bot, message, args) => {
        ...
        if(!args[0]) {
            ...
            const embed = new Discord.MessageEmbed()
                ...
                .setTitle('Quote')
                .addField('Choose what kind of quote you want:', `:smiley: - happy\n:slight_frown: - sad\n:rage: - angry\n:yawning_face: - bored`)
                .setColor(0x4AEFBA)
                ...
                .then(collected => {
                    ...
                    if(reaction.emoji.name === '😃') {
                        const embed = new Discord.MessageEmbed()
                            ...
                            .setTitle('Quote')
                            .addField('Happy:', `${happy_q[Math.floor(Math.random() * happy_q.length)]}`)
                            .setColor(0x4AEFBA)
                        msg.edit(embed);
                        ...
                        const embed = new Discord.MessageEmbed()
                            ...
                            .setTitle('Quote')
                            .addField('Sad:', `${sad_q[Math.floor(Math.random() * sad_q.length)]}`)
                            .setColor(0x4AEFBA)
                        msg.edit(embed);
                    }else if(reaction.emoji.name === '😡') {
                        const embed = new Discord.MessageEmbed()
                        ...
                        const embed = new Discord.MessageEmbed()
                            ...
                            .setTitle('Quote')
                            .addField('Bored:', `${bored_q[Math.floor(Math.random() * bored_q.length)]}`)
                            .setColor(0x4AEFBA)
                        msg.edit(embed);
                    }
                })
