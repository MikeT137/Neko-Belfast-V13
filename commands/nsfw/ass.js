...
module.exports = {
    name:'ass',
    description: "It sends a nsfw gif about ass",
    usage: `${prefix}ass`,
    category: 'nsfw',
            ...
            if(!voted) {
                ...
                reddit({
                    ...
                    const embed = new Discord.MessageEmbed()
                        ...
                        .setTitle(post.title)
                        .setImage(post.url)
                        .setFooter(`Posted in r/Animebooty`, 'https://cdn.discordapp.com/emojis/697937639701086268.png?v=1')
                        .setColor('#7d77df')
