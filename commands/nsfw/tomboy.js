...
module.exports = {
    name:'tomboy',
    description: "It sends a nsfw gif about tomboys",
    usage: `${prefix}tomboy`,
    category: 'nsfw',
            ...
            if(!voted) {
                ...
                reddit({
                    ...
                    const embed = new Discord.MessageEmbed()
                        ...
                        .setTitle(post.title)
                        .setImage(post.url)
                        .setFooter(`Posted in r/Tomboy_Hentai`, 'https://cdn.discordapp.com/emojis/697937639701086268.png?v=1')
                        .setColor('#7d77df')
