...
module.exports = {
    name:'darkskin',
    description: "It sends a nsfw gif about people with dark skin",
    usage: `${prefix}darkskin`,
    category: 'nsfw',
            ...
            if(!voted) {
                ...
                reddit({
                    ...
                    const embed = new Discord.MessageEmbed()
                        ...
                        .setTitle(post.title)
                        .setImage(post.url)
                        .setFooter(`Posted in r/Kuroihada`, 'https://cdn.discordapp.com/emojis/697937639701086268.png?v=1')
                        .setColor('#7d77df')
