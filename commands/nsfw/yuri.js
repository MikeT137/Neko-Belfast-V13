...
module.exports = {
    name:'yuri',
    description: "It sends a nsfw image about homosexuality between females",
    usage: `${prefix}yuri`,
    category: 'nsfw',
            ...
            if(!voted) {
                ...
                reddit({
                    ...
                    const embed = new Discord.MessageEmbed()
                        ...
                        .setFooter(`Posted in r/Yuri`, 'https://cdn.discordapp.com/emojis/697937639701086268.png?v=1')
                        .setColor('#7d77df')
