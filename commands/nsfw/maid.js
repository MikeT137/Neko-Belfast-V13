...
module.exports = {
    name:'maid',
    description: "It sends a nsfw image about maids",
    usage: `${prefix}maid`,
    category: 'nsfw',
            ...
            if(!voted) {
                ...
                reddit({
                    ...
                    const embed = new Discord.MessageEmbed()
                        ...
                        .setFooter(`Posted in r/MaidHentai`, 'https://cdn.discordapp.com/emojis/697937639701086268.png?v=1')
                        .setColor('#7d77df')
