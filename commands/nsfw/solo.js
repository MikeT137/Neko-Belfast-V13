...
module.exports = {
    name:'solo',
    description: "It sends a nsfw image about masturbation",
    usage: `${prefix}solo`,
    category: 'nsfw',
            ...
            if(!voted) {
                ...
                reddit({
                    ...
                    const embed = new Discord.MessageEmbed()
                        ...
                        .setFooter(`Posted in r/MasturbationHentai`, 'https://cdn.discordapp.com/emojis/697937639701086268.png?v=1')
                        .setColor('#7d77df')
