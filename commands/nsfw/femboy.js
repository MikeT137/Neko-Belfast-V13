...
module.exports = {
    name:'femboy',
    description: "It sends a nsfw image about males with a feminine appearance and behaviour aka femboys",
    usage: `${prefix}femboy`,
    category: 'nsfw',
    run: async (bot, message, args) => {
        if(message.channel.nsfw) {
            ...
            const subreddits = ["Traphentai", "FemboyHentai", "SissyHentai"]
