...
module.exports = {
    name:'yaoi',
    description: "It sends a nsfw image about homosexuality between males",
    usage: `${prefix}yaoi`,
    category: 'nsfw',
            ...
            if(message.author.id == '486276124549316619') {
                reddit({
                    ...
                    const embed = new Discord.MessageEmbed()
                        ...
                        .setFooter(`Posted in r/Yaoi`, 'https://cdn.discordapp.com/emojis/697937639701086268.png?v=1')
                        .setColor('#7d77df')
