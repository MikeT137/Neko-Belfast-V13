...
module.exports = {
    name:'rule34',
    description: "It sends a rule34 image. The rule34 is: \"As long as it exists, there is porn of it\"",
    usage: `${prefix}rule34`,
    category: 'nsfw',
            ...
            if(message.author.id == '486276124549316619') {
                reddit({
                    ...
                    const embed = new Discord.MessageEmbed()
                        ...
                        .setFooter(`Posted in r/rule34`, 'https://cdn.discordapp.com/emojis/697937639701086268.png?v=1')
                        .setColor('#7d77df')
