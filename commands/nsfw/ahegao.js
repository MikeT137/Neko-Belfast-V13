...
module.exports = {
    name:'ahegao',
    description: "It sends a nsfw image about exagerated facial epressions during sex aka ahegao",
    usage: `${prefix}ahegao`,
    category: 'nsfw',
            ...
            if(message.author.id == '486276124549316619') {
                reddit({
                    ...
                    const embed = new Discord.MessageEmbed()
                        ...
                        .setFooter(`Posted in r/Ahegao`, 'https://cdn.discordapp.com/emojis/697937639701086268.png?v=1')
                        .setColor('#7d77df')
